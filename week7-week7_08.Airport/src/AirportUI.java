...
public class AirportUI {
    ...
    private void addPlane() {
        ...
        Airplane pln = new Airplane(planeID, planeCap);
    ...
    private void addFlight() {
        ...
        Airplane pla = getPlane(planeID);

        Flight ff = new Flight(pla, origin, destination);
        this.flight.add(ff);
    }

    private Airplane getPlane(String word) {
        for (Airplane pl : plane) {
